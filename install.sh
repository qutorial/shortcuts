...
curl https://raw.https://raw.githubusercontent.com/qutorial/shortcuts/master/{name} > {local}curl https://raw.https://raw.githubusercontent.com/qutorial/shortcuts/master/{name} > {local}