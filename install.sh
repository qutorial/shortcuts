...
source ~/.bashrc
curl https://raw.githubusercontent.com/qutorial/shortcuts/master/dolphinrc > ~/.config/dolphinrc
curl https://raw.githubusercontent.com/qutorial/shortcuts/master/kwinrc > ~/.config/kwinrc
